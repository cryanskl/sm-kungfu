...
const MIGRATION_SQL = [
  ...
  `ALTER TABLE game_state ADD COLUMN IF NOT EXISTS batch_progress JSONB DEFAULT '{}'`,
  `ALTER TABLE game_state ADD COLUMN IF NOT EXISTS display_started_at TIMESTAMPTZ`,
  `ALTER TABLE game_state ADD COLUMN IF NOT EXISTS display_round INTEGER`,
